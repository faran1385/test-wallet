        ...
        <div className={"sm:mt-8 my-auto"}>
          <div className="flex flex-col items-center justify-center gap-3">
            ...
            <p className="text-[14px]  font-normal text-[#686D74] text-center">
              Choose a name for your new wallet, and a default currency in which
              you want to see your wallet balance.
            </p>
            <div className="flex w-full mt-6 flex-col gap-2">
              ...
              <div
                ...
                className={`rounded-[48px] border-[1px] ${
                  inputIsValid ? "border-wallet-green" : ""
                } flex relative `}
              >
                <input
                  value={walletName}
