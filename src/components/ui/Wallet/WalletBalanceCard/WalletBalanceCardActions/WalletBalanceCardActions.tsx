    ...
    return <div className="w-full h-full flex items-center justify-center">
        ...
        >
            <div className="w-full grid grid-cols-3 items-center py-3">
                <div>
                    <a
                        href="../send review/SendReview_1.html"
                        className="flex flex-col items-center justify-center"
                    >
                        <button className={"flex justify-center flex-col gap-1 items-center"}>
                            <div className="rounded-full bg-[#E8F0FF] p-2 md:w-auto w-12 md:h-auto h-12 md:block flex justify-center items-center md:bg-transparent md:p-0 duration-200">
                                <svg width="22" height="22" viewBox="0 0 22 25" fill="none"
                            ...
                            <span className="text-xs font-medium md:text-base text-[#1B65FF] duration-200">Send</span>
                        </button>
                    </a>
                </div>
                <div>
                    <a
                        href="../add asset/index.html"
                        className="flex flex-col items-center justify-center"
                    >
                        <button className={"flex  items-center justify-center gap-1 flex-col"}>
                            <div
                ...
                <div>
                    <a
                        href="../exchangeAsset/confirmation.html"
                        className="flex flex-col items-center justify-center"
                    >
                        <button className={"flex flex-col items-center  gap-1 justify-center"}>
                            <div
