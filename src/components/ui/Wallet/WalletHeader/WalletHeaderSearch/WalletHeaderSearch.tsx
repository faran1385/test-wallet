export const WalletHeaderSearch = () => {
    return <>
        <div
            className={"relative flex-grow md:flex-grow-0 md:px-0 px-4 text-black"}>
            <svg className={"top-[10px] right-[30px] md:right-[15px]  absolute"} width="18" height="19" viewBox="0 0 18 19" fill="none"
            ...
            <input
                className={'placeholder-[#686D74] min-w-[230px] w-full text-[14px] bg-[#EBEEF1] rounded-[45px] outline-0 ps-5 py-2 pe-10'}
                placeholder={'Hero anything... '}
            />
        </div>
    </>
}