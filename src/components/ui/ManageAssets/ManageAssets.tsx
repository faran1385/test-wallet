...
import "./style.css";
import useFetchAssets from "../../lib/useFetchAssets/useFetchAssets.ts";
...
export const ManageAssets = () => {
  const { assets, loading } = useFetchAssets({
    pageId: 1,
    pageCount: 100,
    ...
    <>
      <main className="w-[90%] h-dvh sm:max-w-[1024px] mx-auto flex flex-col mt-8 pb-4">
        <div className="w-full flex justify-center items-center relative sm:hidden">
          ...
          <h2 className="sm:me-[inherit] me-auto font-semibold sm:font-bold text-base text-center sm:text-[32px]">
            Add Assets
          </h2>
        </div>
